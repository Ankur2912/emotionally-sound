...
st.title("EMOTIONALLY SOUND")
st.write('Emotionally Sound is emotion detection based music reccommendation system. To get reccommended songs, start by allowing mic and camera for this web app.')
...
if btn:
	if not(detected_emotion):
		...
		webbrowser.open(f"https://open.spotify.com/search/{lang}%20{artist}%20{detected_emotion}%20Playlist")
